...
import 'package:recon_subsea_app/screens/home/task_list.dart';
                ...
                body: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Text(' To do ', style: TextStyle(color: Colors
                                .blueAccent,
                                fontSize: 25,
                                fontWeight: FontWeight.bold),),
                            SizedBox(width: 110,),
                                                ...
                                                FlatButton(
                                                    ...
                                                    onPressed: () {
                                                      setState(() {
                                                        ...
                                                        tempOutput = new List<String>.from(snapshot.data['todo']);

                                                        tempOutput.add(this._field);
                                                        tempOutput.remove('');

                                                        print(snapshot.data['todo']);
                                                      ...
                                                      Firestore.instance.collection('domains').document(args.domain).setData(
                                                          {'todo': tempOutput ,'progress':snapshot.data['progress'],'done':snapshot.data['done']});
                      ...
                      Container(
                        child: TaskList(domain:args.domain),
