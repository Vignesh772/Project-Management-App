            ...
            body: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Text(' In Progress ', style: TextStyle(color: Colors
                            .blueAccent,
                            fontSize: 25,
                            fontWeight: FontWeight.bold),),
                        SizedBox(width: 70,),
                                            ...
                                            FlatButton(
                                                ...
                                                onPressed: () {
                                                  setState(() {
                                                    ...
                                                    tempOutput = new List<String>.from(snapshot.data['progress']);

                                                    tempOutput.add(this._field);
                                                    tempOutput.remove('');

                                                    print(snapshot.data['progress']);
                                                  ...
                                                  Firestore.instance.collection('domains').document(args.domain).setData(
                                                      {'todo': snapshot.data['todo'] ,'progress':tempOutput,'done':snapshot.data['done']});
                  ...
                  Container(
                    child: ProgressList(domain:args.domain),
